...
## WorldCities data loading
```{r}
Worldcities <- st_read(here::here("CHAP5",
                                  "Data",
                                  "Raw",
                                  "World_Cities", 
                                  "World_Cities.shp")) %>%
...
## UK outline data loading
```{r}
UK_outline <- st_read(here::here("CHAP5",
                                 "Data",
                                 "Raw",
                                 "gadm36_GBR_shp", 
                                 "gadm36_GBR_0.shp")) %>%
...
## London Borough data loading
```{r}
#London Borough data is already in 277000
Londonborough <- st_read(here::here("CHAP5",
                                    "Data",
                                    "Raw",
...
## inside bnb csv file loading
```{r}
# read in the .csv
# and make it into spatial data

Airbnb <- read_csv("Data/Raw/csv/listings.csv") %>%
...
Joinlalala <- function(data1, data2){
...
Hotels <- Joinlalala(OSM, Londonborough)

# then for airbnb
Airbnb <- Joinlalala(Airbnb, Londonborough)
